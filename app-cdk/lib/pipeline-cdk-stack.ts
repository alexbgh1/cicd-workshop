...
export class PipelineCdkStack extends Stack {
  constructor(scope: Construct, id: string, props: ConsumerProps) {
    ...
    const emailSubscription = new subscriptions.EmailSubscription("example@gmail.com");
    ...
    // Update Prod stage with action CodeDeployEcsDeployAction
    ...
    new cloudwatch.Dashboard(this, "CICD_Dashboard", {
      ...
      widgets: [[buildRate, buildsCount, averageDuration, queuedDuration, downloadDuration]],
    });
